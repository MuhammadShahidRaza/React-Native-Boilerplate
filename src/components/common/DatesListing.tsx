      ...
      renderItem={({ item, index }) => (
        <TouchableOpacity
          ...
          style={[
            styles.dateButton,
            {
              backgroundColor: selectedDate === item.date ? COLORS.SECONDARY : COLORS.BACKGROUND,
            },
          ]}
        >
          <Typography
            style={{
              ...
              color: selectedDate === item.date ? COLORS.TEXT_INVERSE : COLORS.TEXT_SECONDARY,
            }}
          >
            {item?.date.toString()}
          </Typography>
          <Typography
            style={{
              color: selectedDate === item.date ? COLORS.TEXT_INVERSE : COLORS.GRAY,
            }}
          >
            {item.weekday}
          </Typography>
