...
import { Wrapper, Typography, RowComponent, Button, ModalComponent, Header } from 'components/index';
      ...
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <View style={{ marginStart:10,marginTop:10}}>
            ...
            <Typography style={styles.description}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</Typography>
          </View>
        </View>
        ...
        //   <RowComponent style={styles.actionRow}>
            <View>
                      ...
                      <RowComponent style={{ justifyContent:'space-between' }}>
                          <View>
                              <Typography style={{fontSize:FontSize.Large,fontWeight:'700'}}>Reschedule Booking:</Typography>
                              <Typography style={{fontSize:FontSize.Small,fontWeight:'400',color:COLORS.BOOKING_DESC}}>Booking can only be rescheduled 12 hours before the service  time.</Typography>
                          </View>
                          <Button title="Reschedule" onPress={() => handleAction('reschedule')} style={styles.rescheduleBtn} />
                      </RowComponent><RowComponent style={{ justifyContent: 'space-around' }}>
                          <View>
                              <Typography style={{fontSize:FontSize.Large ,fontWeight:'700'}}>Cancel Booking:</Typography>
                              <Typography style={{fontSize:FontSize.Small,fontWeight:'400',color:COLORS.BOOKING_DESC}}>Booking can be Cancelled within 6 Hours of initiation. After cutoff time penalty fee will be charged.</Typography>
                          </View>
                          <Button title="Cancel Booking" onPress={() => handleAction('cancel')} style={styles.cancelBtn} />
                      </RowComponent>
                      </View>
        )}
        ...
        {booking.status === 'Completed' && (
          <View style={{ marginTop: 20 }}>
            ...
            />
            <Button title="Submit" onPress={() => {}} textStyle={{fontWeight:'700'}} style={styles.primaryBtn} />
          </View>
        )}
        ...
        {booking.status === 'Active' && timer >= 0 && (
          <View style={styles.timerBox}>
            ...
            <Typography style={styles.timerValue}>0{timer}:0{timer}</Typography>
          </View>
        )}
      </View>
...
const styles = StyleSheet.create({
  ...
  feedBackText: { fontSize: FontSize.Large,textAlign:'center',fontWeight:'700',color:'#2C2C2C', marginBottom: 4 },
  bold: { fontWeight: 'bold' },
  actionRow: { justifyContent: 'space-between', marginVertical: 10 },
  rescheduleBtn: { backgroundColor: COLORS.PRIMARY, width: '48%' },
  cancelBtn: { backgroundColor: COLORS.PRIMARY, width: '48%' },
  primaryBtn: { marginTop: 20,alignSelf:'center' },
  feedbackBox: { borderWidth: 1, borderColor: COLORS.BORDER, borderRadius: 10, padding: 10, height: 100, textAlignVertical: 'top', marginVertical: 10 },
  timerBox: { alignItems: 'center', marginTop: 20, padding: 16, borderWidth: 4, borderColor: COLORS.BLACK, borderRadius: 10,width:300,alignSelf:'center' },
