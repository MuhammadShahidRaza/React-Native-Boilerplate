export const API_ROUTES = {
  ...
  DRIVER_BOOKING_REJECT: (id: number | string) => `driver/bookings/${id}/reject`,
  ...
  COURIER_BOOKING_REJECT: (id: number | string) => `courier/bookings/${id}/reject`,
  ...
  RESTAURANT_MENU: (id: number | string) => `restaurants/${id}/menu`,
  ...
  COURIER_WALLET_TRANSACTIONS: 'courier/wallet/transactions',
  COURIER_WALLET_SUMMARY: 'courier/wallet/summary',
  USER_WALLET_SUMMARY: 'user/wallet-summary',
  SNLIFT_REVIEW_CREATE: 'review/create',
  USERS_ALL: 'user/all',
  WALLET_STRIPE_CONNECT: 'wallet/stripe-connect/link',
  LEGACY_USER_BOOKING_LIST: 'userbooking/list',
  LEGACY_DENTOR_BOOKING_LIST: 'dentorbooking/list',
  LEGACY_CONVERSATION_LIST: 'conversation/list',
  LEGACY_MESSAGE_LIST: 'message/list',
};
